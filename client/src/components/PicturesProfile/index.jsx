...
const PictureProfile = () => {
  ...
  const handleRenderPicture = () => {
    ...
    return arr.map((image, index) => {
      index++;
      if (arr.length === 1) {
        return <img src={image} className={classes.image4Radius} />;
        ...
        if (arr.length === 3) {
          if (index == arr.length - 1) {
            return <img src={image} className={classes.image0Radius} />;
          } else if (index % 3 !== 0) {
            return (
              <img
                src={image}
          ...
          if (index === 1) {
            return <img src={image} className={classes.image1TopLeftRadius} />;
          } else if (index === 3) {
            return <img src={image} className={classes.image1TopRightRadius} />;
          } else if (index === 4) {
            return (
        ...
        if (index === 1) {
          ...
          return <img src={image} className={classes.image1BottomLeftRadius} />;
        } else if (index === 9) {
          return (
            <img src={image} className={classes.image1BottomRightRadius} />
          );
